...
curl -s -L -o C:\Users\Public\Desktop\UnityHub.exe https://public-cdn.cloud.unity3d.com/hub/prod/UnityHubSetup.exe
...
C:\Users\Public\Desktop\UnityHub.exe /S
del C:\Users\Public\Desktop\UnityHub.exe
